...
**Released:** Contact the development team for the specific release date.

This release of the Jaspersoft Connector (SMARunJasperReportJobIII) includes support for JasperServer 5.6 and higher via the REST Version 2 interface.

:::info Note

Contact the development team for a complete list of changes included in this release.
